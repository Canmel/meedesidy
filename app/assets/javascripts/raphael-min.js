                ...
                if (d[f](n)) {
                    ...
                    switch (n) {
                        ...
                        case"cx":
                            ...
                            if(isNaN(o) && h) {
                                if(h.localName == 'text' && n == 'x'){
                                    o = h.previousSibling.attributes.x.value;
                                    if(h.previousSibling.localName == 'rect'){
                                        o = parseFloat(o) + parseFloat(h.previousElementSibling.attributes.width.value)/2;
                                        o.toString();
                                    }
                                }else if(h.localName == 'image' && n == 'x'){
                                    o = h.previousSibling.attributes.x.value;
                                    if(h.previousSibling.localName == 'rect'){
                                        o = parseFloat(o) + parseFloat(h.previousElementSibling.attributes.width.value)/2;
                                        o.toString();
                                    }
                                }else if(h.localName == 'rect' && n == 'x'){
                        ...
                        case"cy":
                            ...
                            if(isNaN(o) && h) {
                                if(h.localName == 'image'){
                                    o = h.previousSibling.attributes.x.value;
                                    if(h.previousSibling.localName == 'rect'){
                                        o = parseFloat(o) + parseFloat(h.previousElementSibling.attributes.width.value)/2　;
                                        o.toString();
                                    }
                                }else if(h.localName == 'rect'){
                                    o = h.previousSibling.attributes.x.value;
                                }else{
                                    console.error("有问题2");
                                }
